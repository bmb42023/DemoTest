<header>
    <div class="topbar d-flex align-items-center">
        ...
        $profileData =  App\Models\User::find($id);
           @endphp 
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src= "{{ (!empty($profileData->photo))? url('upload/admin_image/'.$profileData->photo):url('upload/no_image.jpg') }}" class="user-img" alt="user avatar">
                    <div class="user-info">
                        <p class="user-name mb-0">Bilal {{$profileData->name}}</p>
                        <p class="designattion mb-0">Web @ {{$profileData->email}}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
         ...
         <li><a class="dropdown-item d-flex align-items-center" href="{{url('instructor/logout')}}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
