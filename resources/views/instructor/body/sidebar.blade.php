<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Bmb Instructor </h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        <li>
            <a href="{{route('admin.dashboard')}}">
                ...
                <div class="menu-title">Instructor Dashbaord</div>
            </a>
        </li>
    ...
    -->
        <li>
            ...
            <ul>
                <li> <a href="app-emailbox.html"><i class='bx bx-radio-circle'></i>Front Desk</a>
                </li>
                <li> <a href="app-chat-box.html"><i class='bx bx-radio-circle'></i>Receivable Account</a>
                </li>
                <li> <a href="app-fullcalender.html"><i class='bx bx-radio-circle'></i>Inventory</a></li>
                <li> <a href="app-to-do.html"><i class='bx bx-radio-circle'></i>Sales</a>
                </li>
                <li> <a href="app-file-manager.html"><i class='bx bx-radio-circle'></i>User Management</a>
                </li>
                 <li> <a href="app-invoice.html"><i class='bx bx-radio-circle'></i>Invoice</a>
                </li>
                <li> <a href="app-fullcalender.html"><i class='bx bx-radio-circle'></i>Account</a></li>
                <li> <a href="app-contact-list.html"><i class='bx bx-radio-circle'></i>HR Management</a>
                </li>
                
                <li> <a href="app-fullcalender.html"><i class='bx bx-radio-circle'></i>Setting</a></li>
    ...
    -->
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">POINT OF SALES </div>
            </a>
            <ul>
