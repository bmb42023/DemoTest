...
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
    <div class="media media-card align-items-center">
        <div class="media-img media--img media-img-md rounded-full">
            <img class="rounded-full" src="{{(!empty($profileData->photo))? url('upload/user_image/'.$profileData->photo):url('upload/no_image.jpg')}}" alt="Student thumbnail  image">
        </div>
        <div class="media-body">
            <h2 class="section__title fs-30">Welcome   {{ $profileData->name}}, To dashboard </h2>
            <div class="rating-wrap d-flex align-items-center pt-2">
                {{-- <div class="review-stars">   ITS Statci Data need tomake dynamic
    ...
    <div class="setting-body">
        ...
        <div class="media media-card align-items-center">
            <div class="media-img media-img-lg mr-4 bg-gray">
                <img class="mr-3" src="{{(!empty($profileData->photo))?
                 url('upload/user_image/'.$profileData->photo):
                 url('upload/no_image.jpg')}}" alt="avatar image">
            </div>
            <div class="media-body">
