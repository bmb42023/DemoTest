...
<img  src="{{(!empty
($profileData->photo)) ? url('upload/user_image/'.
$profileData->photo):url('upload/no_image.jpg')}}" alt="Avatar image" width="16px" height="16px" >
...
<img  src="{{(!empty
($profileData->photo))? url('upload/user_image/'.
$profileData->photo):url('upload/no_image.jpg')}}" alt="Avatar image" width="100px" height="100px" >
                                                        </a>
                            <div class="ml-2">
