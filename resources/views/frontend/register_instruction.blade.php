...
@include('frontend.InstructorHome.feature-area')
@include('frontend.InstructorHome.funfact-area')
  ...
  <form method="post" class="row">
    <div class="input-box col-lg-6">
        ...
        <div class="form-group">
            <input class="form-control form--control  @error( 'name')  is-invalid@enderror" id="name"    type="text" name="name" placeholder=" Name">
    ...
    <div class="input-box col-lg-6">
        ...
        <div class="form-group">
        <input class="form-control form--control  @error( 'username')  is-invalid@enderror" id="user_name"    type="text" name="username" placeholder=" ">
            <span class="la la-user input-icon"></span>
            @error('username')
             <span  class="text-danger" role="alert">{{$message}}</span>
            @enderror
    ...
    <div class="input-box col-lg-6">
        ...
        <input type="email" id="email" name="email"  class="form-control 
                            @error( 'email')
                                is-invalid
                            @enderror "  placeholder="jhon@example.com">
                            <span class="la la-user input-icon"></span>
                            @error('email')
                            <span  class="text-danger" role="alert">{{$message}}</span>
                           @enderror
    ...
    <div class="input-box col-lg-6">
        ...
        <input type="text" id="phone" name="phone"  class="form-control 
                            @error( 'phone')
                                is-invalid
                            @enderror "  placeholder="+2519999999">
                            <span class="la la-user input-icon"></span>
                            @error('phone')
                            <span  class="text-danger" role="alert">{{$message}}</span>
                           @enderror
