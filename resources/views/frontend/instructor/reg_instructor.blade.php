...
<section class="register-area section--padding dot-bg overflow-hidden">
  ...
  <form method="post"    action="{{route('instructor.register')}}"   class="row">
    ...
    <div class="input-box col-lg-6">
        ...
        <div class="form-group">
              <input class="form-control form--control  @error('email')
                                is-invalid
                            @enderror "         type="email" name="email" placeholder="e.g. alexsmith@gmail.com">
     ...
     <div class="input-box col-lg-6">
        <label class="label-text">Phone Number</label>
                <div class="form-group">
                        <input id="phone" class="form-control form--control    @error('phone')
                                is-invalid
                                    @enderror "      type="text" name="phone">
                                    <span class="la la-user input-icon"></span>
                            @error('phone')
                            <span  class="text-danger" role="alert">{{$message}}</span>
                           @enderror
    ...
    <div class="input-box col-lg-12">
        ...
        <div class="form-group">
            <input class="form-control form--control     
                            @error('address')
                                is-invalid
                            @enderror "          type="text" name="address"  placeholder="e.g. 12345 Little Baker St, CA">
