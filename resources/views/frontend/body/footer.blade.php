            ...
            <div class="col-lg-3   responsive-column-half ">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item pt-4">
                        <li><a href="tel:+1631237884"> 123 7884</a></li>
                        <li><a href="mailto:support@wbsite.com">support@website.com</a></li>
                        <li>AddissAbaba , Ethiopia, Kolfe keraniyo</li>
                    </ul>
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc">&copy; 2024 bmb. All Rights Reserved. by <a href="https://techydevs.com/">TechyDevs</a></p>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
