...
<div class="page-content">
    ...
    <div class="container">
                    ...
                    <form method="POST" action="{{route('admin.profile.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{(!empty($profileData->photo))? url('upload/admin_image/'.$profileData->photo):url('upload/no_image.jpg')}}" alt="Admin" class="showImage rounded-circle p-1 bg-primary" width="110">
        ...
        <button class="btn btn-outline-primary">Message</button>
               ...
               <img id="showImage"   src="{{(!empty($profileData->photo))? url('Upload/admin_image/'.$profileData->photo):
...
//     reader.onload = function(e) {
//       try {
//         // Attempt to access the 'getContext()' method
//         var canvas = document.getElementById('showImage');
//         var ctx = canvas.getContext('2d');
//         // Rest of your code here
//       } catch (error) {
//         console.error('Error:', error);
//         // Provide an alternative or fallback functionality
//         $('#showImage').attr('src', e.target.result);
//       }
//     }
//     reader.readAsDataURL(e.target.files[0]);
